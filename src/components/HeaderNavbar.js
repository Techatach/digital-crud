...
export default function HeaderNavbar() {
  return (
    <div className="shadow-lg p-5 mb-9 bg-body rounded first-letter:">
          ...
          <div class="flex justify-center items-center text-gray-700">
            ...
            <ul class="hidden md:flex items-center text-[18px] font-semibold pr-10">
              <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1">
                <a href="/team">หลักสูตรรัฐประศาสนศาสตร์</a>
              </li>
              <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1">
                <a href="/team">หน้าหลัก</a>
              </li>
              <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1">
              ...
              <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1">
                <a href="/evaluate">การประเมินนโยบายสาธารณะ</a>
              </li>
              <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1">
